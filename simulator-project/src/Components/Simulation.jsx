      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <a
            ...
            className={`group relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 transform hover:scale-105 hover:shadow-2xl ${isActive("MM1")
                ? "ring-4 ring-[#2C80D3] ring-opacity-60"
                : ""
              }`}
          >
            <div className="bg-gradient-to-r from-[#2C80D3] to-[#0C3E72] p-8 text-white h-48 flex flex-col justify-between">
              <div>
          ...
          <a
            ...
            className={`group relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 transform hover:scale-105 hover:shadow-2xl ${isActive("MMCSimulation")
                ? "ring-4 ring-[#2C80D3] ring-opacity-60"
                : ""
              }`}
          >
          ...
          <a
            ...
            className={`group relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 transform hover:scale-105 hover:shadow-2xl ${isActive("MGCSimulation")
                ? "ring-4 ring-[#2C80D3] ring-opacity-60"
                : ""
              }`}
          >
          ...
          <a
            ...
            className={`group relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 transform hover:scale-105 hover:shadow-2xl ${isActive("GGCSimulation")
                ? "ring-4 ring-[#2C80D3] ring-opacity-60"
                : ""
              }`}
          >
